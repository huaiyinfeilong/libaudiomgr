...
#ifndef __IAudioPolicyConfig2_FWD_DEFINED__
#define __IAudioPolicyConfig2_FWD_DEFINED__
typedef interface IAudioPolicyConfig2 IAudioPolicyConfig2;

#endif 	/* __IAudioPolicyConfig2_FWD_DEFINED__ */
...
#ifndef __IAudioPolicyConfig2_INTERFACE_DEFINED__
#define __IAudioPolicyConfig2_INTERFACE_DEFINED__

/* interface IAudioPolicyConfig2 */
/* [object][uuid] */ 


EXTERN_C const IID IID_IAudioPolicyConfig2;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("ab3d4648-e242-459f-b02f-541c70306324")
    IAudioPolicyConfig2 : public IInspectable
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE __incomplete__add_CtxVolumeChange( void) = 0;
    ...
    typedef struct IAudioPolicyConfig2Vtbl
    {
        BEGIN_INTERFACE
        
        DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IAudioPolicyConfig2 * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__add_CtxVolumeChange)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__add_CtxVolumeChange )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__remove_CtxVolumeChanged)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__remove_CtxVolumeChanged )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__add_RingerVibrateStateChanged)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__add_RingerVibrateStateChanged )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__remove_RingerVibrateStateChange)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__remove_RingerVibrateStateChange )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__SetVolumeGroupGainForId)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__SetVolumeGroupGainForId )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__GetVolumeGroupGainForId)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__GetVolumeGroupGainForId )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__GetActiveVolumeGroupForEndpointId)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__GetActiveVolumeGroupForEndpointId )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__GetVolumeGroupsForEndpoint)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__GetVolumeGroupsForEndpoint )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__GetCurrentVolumeContext)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__GetCurrentVolumeContext )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__SetVolumeGroupMuteForId)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__SetVolumeGroupMuteForId )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__GetVolumeGroupMuteForId)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__GetVolumeGroupMuteForId )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__SetRingerVibrateState)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__SetRingerVibrateState )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__GetRingerVibrateState)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__GetRingerVibrateState )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__SetPreferredChatApplication)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__SetPreferredChatApplication )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__ResetPreferredChatApplication)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__ResetPreferredChatApplication )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__GetPreferredChatApplication)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__GetPreferredChatApplication )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__GetCurrentChatApplications)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__GetCurrentChatApplications )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__add_ChatContextChanged)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__add_ChatContextChanged )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, __incomplete__remove_ChatContextChanged)
        HRESULT ( STDMETHODCALLTYPE *__incomplete__remove_ChatContextChanged )( 
            IAudioPolicyConfig2 * This);
        
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, SetPersistedDefaultAudioEndpoint)
        HRESULT ( STDMETHODCALLTYPE *SetPersistedDefaultAudioEndpoint )( 
            IAudioPolicyConfig2 * This,
            /* [in] */ UINT processId,
            /* [in] */ EDataFlow flow,
        ...
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, GetPersistedDefaultAudioEndpoint)
        HRESULT ( STDMETHODCALLTYPE *GetPersistedDefaultAudioEndpoint )( 
            IAudioPolicyConfig2 * This,
            /* [in] */ UINT processId,
            /* [in] */ EDataFlow flow,
        ...
        DECLSPEC_XFGVIRT(IAudioPolicyConfig2, ClearAllPersistedApplicationDefaultEndpoints)
        HRESULT ( STDMETHODCALLTYPE *ClearAllPersistedApplicationDefaultEndpoints )( 
            IAudioPolicyConfig2 * This);
        
        END_INTERFACE
    } IAudioPolicyConfig2Vtbl;

    interface IAudioPolicyConfig2
    {
        CONST_VTBL struct IAudioPolicyConfig2Vtbl *lpVtbl;
    };
...
#define IAudioPolicyConfig2_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IAudioPolicyConfig2_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IAudioPolicyConfig2_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IAudioPolicyConfig2_GetIids(This,iidCount,iids)	\
    ( (This)->lpVtbl -> GetIids(This,iidCount,iids) ) 

#define IAudioPolicyConfig2_GetRuntimeClassName(This,className)	\
    ( (This)->lpVtbl -> GetRuntimeClassName(This,className) ) 

#define IAudioPolicyConfig2_GetTrustLevel(This,trustLevel)	\
    ( (This)->lpVtbl -> GetTrustLevel(This,trustLevel) ) 


#define IAudioPolicyConfig2___incomplete__add_CtxVolumeChange(This)	\
    ( (This)->lpVtbl -> __incomplete__add_CtxVolumeChange(This) ) 

#define IAudioPolicyConfig2___incomplete__remove_CtxVolumeChanged(This)	\
    ( (This)->lpVtbl -> __incomplete__remove_CtxVolumeChanged(This) ) 

#define IAudioPolicyConfig2___incomplete__add_RingerVibrateStateChanged(This)	\
    ( (This)->lpVtbl -> __incomplete__add_RingerVibrateStateChanged(This) ) 

#define IAudioPolicyConfig2___incomplete__remove_RingerVibrateStateChange(This)	\
    ( (This)->lpVtbl -> __incomplete__remove_RingerVibrateStateChange(This) ) 

#define IAudioPolicyConfig2___incomplete__SetVolumeGroupGainForId(This)	\
    ( (This)->lpVtbl -> __incomplete__SetVolumeGroupGainForId(This) ) 

#define IAudioPolicyConfig2___incomplete__GetVolumeGroupGainForId(This)	\
    ( (This)->lpVtbl -> __incomplete__GetVolumeGroupGainForId(This) ) 

#define IAudioPolicyConfig2___incomplete__GetActiveVolumeGroupForEndpointId(This)	\
    ( (This)->lpVtbl -> __incomplete__GetActiveVolumeGroupForEndpointId(This) ) 

#define IAudioPolicyConfig2___incomplete__GetVolumeGroupsForEndpoint(This)	\
    ( (This)->lpVtbl -> __incomplete__GetVolumeGroupsForEndpoint(This) ) 

#define IAudioPolicyConfig2___incomplete__GetCurrentVolumeContext(This)	\
    ( (This)->lpVtbl -> __incomplete__GetCurrentVolumeContext(This) ) 

#define IAudioPolicyConfig2___incomplete__SetVolumeGroupMuteForId(This)	\
    ( (This)->lpVtbl -> __incomplete__SetVolumeGroupMuteForId(This) ) 

#define IAudioPolicyConfig2___incomplete__GetVolumeGroupMuteForId(This)	\
    ( (This)->lpVtbl -> __incomplete__GetVolumeGroupMuteForId(This) ) 

#define IAudioPolicyConfig2___incomplete__SetRingerVibrateState(This)	\
    ( (This)->lpVtbl -> __incomplete__SetRingerVibrateState(This) ) 

#define IAudioPolicyConfig2___incomplete__GetRingerVibrateState(This)	\
    ( (This)->lpVtbl -> __incomplete__GetRingerVibrateState(This) ) 

#define IAudioPolicyConfig2___incomplete__SetPreferredChatApplication(This)	\
    ( (This)->lpVtbl -> __incomplete__SetPreferredChatApplication(This) ) 

#define IAudioPolicyConfig2___incomplete__ResetPreferredChatApplication(This)	\
    ( (This)->lpVtbl -> __incomplete__ResetPreferredChatApplication(This) ) 

#define IAudioPolicyConfig2___incomplete__GetPreferredChatApplication(This)	\
    ( (This)->lpVtbl -> __incomplete__GetPreferredChatApplication(This) ) 

#define IAudioPolicyConfig2___incomplete__GetCurrentChatApplications(This)	\
    ( (This)->lpVtbl -> __incomplete__GetCurrentChatApplications(This) ) 

#define IAudioPolicyConfig2___incomplete__add_ChatContextChanged(This)	\
    ( (This)->lpVtbl -> __incomplete__add_ChatContextChanged(This) ) 

#define IAudioPolicyConfig2___incomplete__remove_ChatContextChanged(This)	\
    ( (This)->lpVtbl -> __incomplete__remove_ChatContextChanged(This) ) 

#define IAudioPolicyConfig2_SetPersistedDefaultAudioEndpoint(This,processId,flow,role,deviceId)	\
    ( (This)->lpVtbl -> SetPersistedDefaultAudioEndpoint(This,processId,flow,role,deviceId) ) 

#define IAudioPolicyConfig2_GetPersistedDefaultAudioEndpoint(This,processId,flow,role,pDeviceId)	\
    ( (This)->lpVtbl -> GetPersistedDefaultAudioEndpoint(This,processId,flow,role,pDeviceId) ) 

#define IAudioPolicyConfig2_ClearAllPersistedApplicationDefaultEndpoints(This)	\
    ( (This)->lpVtbl -> ClearAllPersistedApplicationDefaultEndpoints(This) ) 
...
#endif 	/* __IAudioPolicyConfig2_INTERFACE_DEFINED__ */
